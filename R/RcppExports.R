...
DOCX_ <- function(file, bg_, width, height, pointsize, aliases, editable, id, raster_prefix, next_rels_id, standalone) {
    .Call('rvg_DOCX_', PACKAGE = 'rvg', file, bg_, width, height, pointsize, aliases, editable, id, raster_prefix, next_rels_id, standalone)
}
...
PPTX_ <- function(file, bg_, width, height, offx, offy, pointsize, aliases, editable, id, raster_prefix, next_rels_id, standalone) {
    .Call('rvg_PPTX_', PACKAGE = 'rvg', file, bg_, width, height, offx, offy, pointsize, aliases, editable, id, raster_prefix, next_rels_id, standalone)
}
