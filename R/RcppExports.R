...
devDML_ <- function(file, bg_, width, height, offx, offy, pointsize, fontname_serif, fontname_sans, fontname_mono, fontname_symbol, type, editable, id) {
    .Call('rvg_devDML_', PACKAGE = 'rvg', file, bg_, width, height, offx, offy, pointsize, fontname_serif, fontname_sans, fontname_mono, fontname_symbol, type, editable, id)
}
